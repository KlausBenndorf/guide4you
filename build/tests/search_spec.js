...
module.exports = require("selenium-webdriver/testing/assert");
...
(0, _testing.describe)('Search', function () {
  var driver = void 0;
  ...
  (0, _testing.it)('should appear a searchbar', function (done) {
    driver.get(_config2.default.testClient).then(function () {
      return (0, _testUtils.waitUntilMapReady)(driver);
    }).then(function () {
      var searchControl = driver.wait(_seleniumWebdriver.until.elementLocated(_seleniumWebdriver.By.css('.ol-overlaycontainer-stopevent > .g4u-search-control')));
      (0, _assert2.default)(searchControl.isDisplayed()).equalTo(true);
      done();
    });
  });
});
